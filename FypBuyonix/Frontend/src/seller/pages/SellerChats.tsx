        ...
        <div className="min-h-screen bg-gray-50 flex">
            ...
            <div className={`w-64 bg-white shadow-lg fixed top-0 left-0 h-screen overflow-y-auto z-50 transform transition-transform duration-300 ${mobileMenuOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0`}>
                ...
                <nav className="p-4">
                    <div className="space-y-2">
                        ...
                        <Link to="/seller-chats" onClick={() => setMobileMenuOpen(false)} className="flex items-center space-x-3 px-4 py-3 bg-teal-600 text-white rounded-lg font-medium">
            ...
            <div className="flex-1 md:ml-64 flex flex-col">
                ...
                <div className="mb-4 sm:mb-6">
                    <h1 className="text-2xl sm:text-3xl font-bold text-gray-800">Customer Chats</h1>
                    <p className="text-gray-600 mt-1">Respond to customer inquiries</p>
                </div>

                <div className="bg-white rounded-lg shadow-sm border border-gray-200 flex-1 flex" style={{minHeight: '400px'}}>
                    {/* Conversations List */}
